...
- large.txt		 various data files
  medium.txt	 	 
  small.txt
  tiny.txt

- output.txt		 the output you should generate for the medium data
  			 file.

- outputlarge.txt	 the output you should generate for the large data
  			 file.
